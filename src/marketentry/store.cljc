(ns marketentry.store
  "SSoT for the Mongolia (MNG) market-entry compliance actor, behind a
...
(defn demo-data
  ...
  `:investor-foreign-state-ownership-pct` / `:proposed-ownership-pct` /
  `:sector` / `:med-permission-verified?` are ground truth for the
  `foreign-soe-permission-unverified` flagship check (Investment Law
  (2013)'s foreign-state-owned-entity permission gate, Ministry of
  Economy and Development); `:requires-entity-registration?` /
  `:entity-registration-verified?` are ground truth for the conditional
  legal-entity-registration check (General Authority for State
  Registration / LERO -- see `marketentry.facts`)."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Ulaanbaatar Trading LLC" :portal "LERO / General Authority for State Registration"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :investor-foreign-state-ownership-pct 0 :proposed-ownership-pct 100 :sector :mining
             :med-permission-verified? false
             :requires-entity-registration? true :entity-registration-verified? true
             :drafted? false :submitted? false
             :jurisdiction "MNG" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "LERO / General Authority for State Registration"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :investor-foreign-state-ownership-pct 0 :proposed-ownership-pct 100 :sector :mining
             :med-permission-verified? false
    ...
    "eng-3" {:id "eng-3" :operator "Gobi Minerals LLC" :portal "LERO / General Authority for State Registration"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "MNG" :status :intake}
    "eng-4" {:id "eng-4" :operator "Erdenet Copper State Holding Co." :portal "LERO / General Authority for State Registration"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :investor-foreign-state-ownership-pct 100 :proposed-ownership-pct 40 :sector :mining
             :med-permission-verified? false
             :requires-entity-registration? true :entity-registration-verified? true
             :drafted? false :submitted? false
             :jurisdiction "MNG" :status :intake}
    "eng-5" {:id "eng-5" :operator "Khan Bank Partners LLC" :portal "LERO / General Authority for State Registration"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :investor-foreign-state-ownership-pct 0 :proposed-ownership-pct 100 :sector :banking-finance
             :med-permission-verified? false
             :requires-entity-registration? true :entity-registration-verified? false
             :drafted? false :submitted? false
             :jurisdiction "MNG" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               investor-foreign-state-ownership-pct proposed-ownership-pct sector med-permission-verified?
                               requires-entity-registration? entity-registration-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? investor-foreign-state-ownership-pct) (assoc :engagement/investor-foreign-state-ownership-pct investor-foreign-state-ownership-pct)
    (some? proposed-ownership-pct)             (assoc :engagement/proposed-ownership-pct proposed-ownership-pct)
    sector                                      (assoc :engagement/sector sector)
    (some? med-permission-verified?)           (assoc :engagement/med-permission-verified? med-permission-verified?)
    (some? requires-entity-registration?)      (assoc :engagement/requires-entity-registration? requires-entity-registration?)
    (some? entity-registration-verified?)      (assoc :engagement/entity-registration-verified? entity-registration-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/investor-foreign-state-ownership-pct :engagement/proposed-ownership-pct :engagement/sector
   :engagement/med-permission-verified?
   :engagement/requires-entity-registration? :engagement/entity-registration-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :investor-foreign-state-ownership-pct (:engagement/investor-foreign-state-ownership-pct m)
     :proposed-ownership-pct (:engagement/proposed-ownership-pct m)
     :sector (:engagement/sector m)
     :med-permission-verified? (boolean (:engagement/med-permission-verified? m))
     :requires-entity-registration? (boolean (:engagement/requires-entity-registration? m))
     :entity-registration-verified? (boolean (:engagement/entity-registration-verified? m))
